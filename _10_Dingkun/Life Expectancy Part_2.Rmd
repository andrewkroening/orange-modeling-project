...
```{r, echo=FALSE, results="asis", header=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
fit2 <- lm(Life.expectancy ~ BMI+GDP+percentage.expenditure+Polio+HIV.AIDS+Total.expenditure+Population+Income.composition.of.resources+Status+Schooling, data=le14)
...
```{r, echo=FALSE, results="asis", header=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
fit2 <- lm(Life.expectancy ~ GDP+percentage.expenditure+HIV.AIDS+Income.composition.of.resources+Status, data=le14)
stargazer(fit2,header=FALSE, type="latex", 
          no.space = TRUE,
          report = ('vcsp*'), single.row = TRUE,
          column.sep.width = "0.2pt",
