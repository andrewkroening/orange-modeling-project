...
```{r, echo=FALSE, results="asis", header=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
fit2 <- lm(Life.expectancy ~ BMI+log10(GDP)+percentage.expenditure+Polio+HIV.AIDS+Total.expenditure+Population+Income.composition.of.resources+Status+Schooling, data=le14)
