...
According to the statistics, for the residual summary statistics, we can see that the median should be close to 0, i.e., the mean of the residuals. 3Q and 1Q should be quantitatively close to each other and symmetrically distributed, and the errors follow a Gaussian distribution. Based on the relationship between the p-value and 0.05, we can conclude that the above five essential factors have an impact on life expectancy. If all other variables are held constant, Adults death probability increase by 0.1% will decrease Life expectancy by 0.03 years (11 days). General government expenditure on health Rise by 1% will increase Life expectancy by 0.03 years (11 days).HIV.aids death rates (which are kids from 0-4 yrs) Rise of 0.1% will decrease Life expectancy by 1.04 years (380 days). Everage BMI Increase of one unit can increase Life expectancy by 0.04 years ( 17 days). Year of Schooling Rise per year will increase Life expectancy by 1.18 years ( 431 days). We also observe from our Adjusted R-squared value 0.8194 that the model explains 82% of the variance in life expectancy.
