...
#,  "pROC", "arm"
packages <- (c("table1", "ggplot2", "xtable", "pander","ggcorrplot", "tidyverse", "stargazer", "ggfortify", "caTools", "car", "corrplot", "gridExtra", "leaps", "Metrics", "reshape2", "moments", "mice", "cowplot", "caret", "AICcmodavg", "GGally"))
...
final_model <- lm(Life.expectancy ~ Status + Status + Population + Life.expectancy + Measles + Polio + HIV.AIDS + GDP + Income.composition.of.resources + BMI + Total.expenditure + Adult.Mortality, data = df_life_expectancy_2014)
...
From the model summary, we can see that the F-statistic is a very small value, less than 0.05, which can be interpreted as ().
